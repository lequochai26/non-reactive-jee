export default class App {
    ...
    async _onInsert() {
        ...
        const response = await fetch(
            "/non-reactive-jee/rest/employee",
            {
                method: "POST",
                headers: [
    ...
    async _onUpdate() {
        ...
        const response = await fetch(
            `/non-reactive-jee/rest/employee/${id}`,
            {
                method: "PUT",
                headers: [
                    ["Content-Type", "application/json"]
    ...
    async _onLoadEmployees() {
        try {
            const response = await fetch("/non-reactive-jee/rest/employee");
    ...
    async _onSearch() {
        ...
        const response = await fetch(
            `/non-reactive-jee/rest/employee?keyword=${keyword}`
        );
